...
def targetingpacks_structure():
    ...
    nuget_test_wrapper(
        name = "microsoft.aspnetcore.app.ref.v8.0.30",
        target_framework = "net8.0",
        runtime_identifier = "linux-x64",
        package = "@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v8.0.30",
    )
    ...
    nuget_targeting_pack_overrides_test(
        ...
        target_under_test = ":microsoft.aspnetcore.app.ref.v8.0.30",
