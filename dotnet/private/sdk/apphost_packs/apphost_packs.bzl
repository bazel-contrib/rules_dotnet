...
def apphost_packs():
    ...
    apphost_pack(name = "net10.0_linux-x64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.linux-x64.v10.0.1", target_framework = "net10.0", runtime_identifier = "linux-x64")
    apphost_pack(name = "net10.0_linux-arm64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.linux-arm64.v10.0.1", target_framework = "net10.0", runtime_identifier = "linux-arm64")
    apphost_pack(name = "net10.0_linux-musl-x64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.linux-musl-x64.v10.0.1", target_framework = "net10.0", runtime_identifier = "linux-musl-x64")
    apphost_pack(name = "net10.0_linux-musl-arm64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.linux-musl-arm64.v10.0.1", target_framework = "net10.0", runtime_identifier = "linux-musl-arm64")
    apphost_pack(name = "net10.0_osx-x64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.osx-x64.v10.0.1", target_framework = "net10.0", runtime_identifier = "osx-x64")
    apphost_pack(name = "net10.0_osx-arm64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.osx-arm64.v10.0.1", target_framework = "net10.0", runtime_identifier = "osx-arm64")
    apphost_pack(name = "net10.0_win-x64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.win-x64.v10.0.1", target_framework = "net10.0", runtime_identifier = "win-x64")
    apphost_pack(name = "net10.0_win-arm64", pack = "@dotnet.apphost_packs//microsoft.netcore.app.host.win-arm64.v10.0.1", target_framework = "net10.0", runtime_identifier = "win-arm64")
