...
def targeting_packs():
    ...
    targeting_pack(name = "default_net10.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.11"], target_framework = "net10.0")
    ...
    targeting_pack(name = "web_net10.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v9.0.11", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.11"], target_framework = "net10.0")
