...
def targeting_packs():
    ...
    targeting_pack(name = "default_net8.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.25"], target_framework = "net8.0")
    targeting_pack(name = "default_net9.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.14"], target_framework = "net9.0")
    targeting_pack(name = "default_net10.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.5"], target_framework = "net10.0")
    ...
    targeting_pack(name = "web_net8.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v8.0.25", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.25"], target_framework = "net8.0")
    targeting_pack(name = "web_net9.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v9.0.14", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.14"], target_framework = "net9.0")
    targeting_pack(name = "web_net10.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v10.0.5", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.5"], target_framework = "net10.0")
