...
def targeting_packs():
    ...
    targeting_pack(name = "default_net8.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.30"], target_framework = "net8.0")
    targeting_pack(name = "default_net9.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.19"], target_framework = "net9.0")
    targeting_pack(name = "default_net10.0", packs = ["@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.11"], target_framework = "net10.0")
    ...
    targeting_pack(name = "web_net8.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v8.0.30", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v8.0.30"], target_framework = "net8.0")
    targeting_pack(name = "web_net9.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v9.0.19", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v9.0.19"], target_framework = "net9.0")
    targeting_pack(name = "web_net10.0", packs = ["@dotnet.targeting_packs//microsoft.aspnetcore.app.ref.v10.0.11", "@dotnet.targeting_packs//microsoft.netcore.app.ref.v10.0.11"], target_framework = "net10.0")
