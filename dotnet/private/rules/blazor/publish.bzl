...
def _blazor_publish_impl(ctx):
    ...
    args.add("--sdk-version", toolchain.dotnetinfo.sdk_version)
    args.add("--host-runtime-version", toolchain.dotnetinfo.runtime_version)
    args.add("--wasm-runtime-version", toolchain.dotnetinfo.wasm_runtime_version)
